...
const App = () => {
  ...
  const handleClick = async () => {
    ...
    const oauthUrl = `https://internal.bloomfire.bs/oauth/authorize?client_id=${clientId}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&scope=openid profile email&state=${encodeURIComponent(communityUrl)}&code_challenge=${challenge}&code_challenge_method=S256`;
